...
Я начинающий .NET Backend разработчик. На данный момент изучаю .NET 8, а также архитектуру кросс-платформенных приложений с применением ASP.NET Core MVC, Blazor и .NET MAUI Hybrid. Имею практику построения и применения REST API, а также минимальных API сервисов. Интересует архитектура приложений с применеием OData и GraphQL. Дополнительно изучаю построение облачно-нативных распределённых систем на базе оркестрации .NET Aspire.




- 🔭 Прохожу стажировку в компании Dex
 
- 🌱 На данный момент разрабатываю проект на базе оркестрации .NET Aspire

- 🏆 Получил II место на IT-олимпиаде компании Dex 2023 
...
<div>
  ...
  <img src="https://github.com/MVasili34/MVasili34/assets/117523384/5f14dacd-39d5-4b1b-81a2-8029090b95af" title="aspire" alt="aspire" width="40" height="40"/>&nbsp
