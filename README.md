...
.NET Backend разработчик. Разработываю системы на базе Clean Architecture и DDD. Активно применяю ASP.NET для построения API сервисов. Изучаю адаптацию приложений для использования AOT-компиляции. Дополнительно изучаю построение облачно-нативных распределённых систем на базе оркестрации .NET Aspire.
